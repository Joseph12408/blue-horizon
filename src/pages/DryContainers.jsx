...
const DryContainers = () => {
  ...
  const dryProducts = useMemo(() => {
    let filtered = products.filter(p => p.categorySlug === 'dry-containers' && p.price <= maxPrice);
  ...
  return (
    <div>
      <PageHero title="Dry Containers" breadcrumbs={['Home', 'Shop', 'Dry Containers']} />
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center mb-8">
              <span className="text-text-muted">Showing {dryProducts.length} results</span>
