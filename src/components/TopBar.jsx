    ...
    <div className="bg-navy border-b border-blue-accent/10 py-2 px-6 hidden md:block">
      <div className="max-w-7xl mx-auto flex justify-between items-center text-xs text-text-muted">
        ...
        <div className="flex space-x-6">
          <a href="mailto:info@bluehorizoncontainers.com" className="flex items-center space-x-2 hover:text-blue-accent transition-colors">
            <Mail size={14} className="text-blue-accent" />
            <span>info@bluehorizoncontainers.com</span>
          </a>
          <a href="tel:+15403841819" className="flex items-center space-x-2 hover:text-blue-accent transition-colors">
